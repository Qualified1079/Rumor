 ...
 */
// MERGE-ZIPPER NOTE: legacy PBEKeySpec(null, …) form crashes on Android BC
// ("password empty") — G20 on check-online replaced it with HKDF-extract.
// Field-verified branch wins here; replace body with HKDF during the zipper.
internal fun platformDeriveAesKey(secret: ByteArray, salt: ByteArray): ByteArray {
    val spec = javax.crypto.spec.PBEKeySpec(null, secret + salt, 1, 256)
